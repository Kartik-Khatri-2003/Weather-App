...
// we removed appid(key) from original apiURL and put it here
const apiKey = "b4d6c5ac4e04c102e21b04b99eb70b45"; 
...
/* This condition checks if the key that was pressed has a keycode equivalent to the 'Enter' key. 
The 'Enter' key has a keycode of 'Enter'. */
